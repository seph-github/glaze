...
class AuthView extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> loginHandler(WidgetRef ref) async {
      final Result<AuthResponse, Exception> response = await ref.watch(loginNotifierProvider.notifier).login(
    ...
    Future<void> signupHandler(WidgetRef ref) async {
      ...
      final Result<AuthResponse, Exception> response = await ref.read(signupNotifierProvider.notifier).signup(
    ...
    Future<void> onAnonymousSignin(WidgetRef ref) async {
      await ref.read(anonymousSigninNotifierProvider.notifier).anonymousSignin();
    }

    return Consumer(
      builder: (context, ref, _) {
        return LoadingLayout(
          isLoading: ref.watch(loginNotifierProvider).isLoading || ref.watch(signupNotifierProvider).isLoading || ref.watch(anonymousSigninNotifierProvider).isLoading,
          child: SafeArea(
            child: Form(
              key: formKey,
              child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    if (!isLogin.value)
                      InputField.text(
                        inputIcon: SvgPicture.asset('assets/images/svg/profile_icon.svg'),
                    ...
                    InputField.email(
                      inputIcon: toggleItems.value[selectedIndex.value] == 'Email' ? SvgPicture.asset('assets/images/svg/email_icon.svg') : SvgPicture.asset('assets/images/svg/phone_icon.svg'),
                    ...
                    const Gap(16),
                    InputField.password(
                      inputIcon: SvgPicture.asset('assets/images/svg/password_icon.svg'),
